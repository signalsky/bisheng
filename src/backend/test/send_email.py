...
if __name__ == "__main__":
    ...
    <html>
        ...
        <body>
            ...
            <p>贵公司<span class="red">如果自己取训练</span>企业内部私有化大模型，则需要消耗大量算力资源，成本会在<span class="red">300-500万</span>，且效果可能不会理想；但我们可以根据贵公司的应用场景，来为贵公司定制最适合的私有化大模型，且<span class="red">系统免费，只按工时收取少量部署费</span>，而且一次部署，永久使用！并附带模型维护优化等服务。</p>
            <br>
